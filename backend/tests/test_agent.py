"""Unit tests for the R2 agent-loop helpers (services/agent.py).
...
pure functions. If the module can't be imported in this environment (missing
settings/secret deps), the whole suite skips cleanly.
"""
import unittest
